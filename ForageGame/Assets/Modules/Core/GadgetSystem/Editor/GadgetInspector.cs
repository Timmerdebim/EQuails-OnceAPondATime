...
{
    [CustomEditor(typeof(Gadget), true)]   // 'true' applies to all subclasses
    public class GadgetInspector : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            // Status banner
            Color bannerColor = gadget.IsActive
                ? new Color(0.18f, 0.65f, 0.18f)
