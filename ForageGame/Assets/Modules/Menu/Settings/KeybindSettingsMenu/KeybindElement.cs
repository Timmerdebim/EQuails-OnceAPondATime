...
namespace Project.Menus.Keybind
{
    ...
    /// </summary>
    [CustomEditor(typeof(KeybindElement))]
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_BindingImageProperty = serializedObject.FindProperty("m_BindingImage");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_BindingImageProperty);
        ...
        private SerializedProperty m_BindingImageProperty;
