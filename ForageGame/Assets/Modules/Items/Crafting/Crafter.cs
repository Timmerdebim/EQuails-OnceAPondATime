...
namespace Project.Items.Crafting
{
    public class Crafter : MonoBehaviour
    {
        ...
        public bool TryCraft()
        {
            ...
            foreach (RecipeItem recipeItem in Inventory.Inventory.Instance.recipeBook.CollectedRecipes)
            {
        ...
        private void CraftRecipe(RecipeItem recipeItem)
        {
            ...
            seq.AppendCallback(() =>
            {
                ...
                transformLid.gameObject.SetActive(false);
                ItemManager.Instance.SpawnItemAt(recipeItem.GetCraftingResult(), transform.position + Vector3.up);
